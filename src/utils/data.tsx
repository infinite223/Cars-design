...
export const data:CarprojectData[] = [
    {
      ...
      car: { 
        ...
        imagesCar: [{url:urlImageCar1}, {url:urlImageCar2}, {url:urlImageCar3}, {url:urlImageCar4}, {url:urlImageCar5}, {url:urlImageCar6}, {url:urlImageCar3}, {url:urlImageCar4}], 
        performance: [
          {type:"hp", value:680}, 
          {type:"nm", value:780}, 
        ...
        likes:2,
        history:[  
          {components: [{type: 'engine',name: 'M54', description:'jakiś silnik', icon:'...'}, {type:'turbo', name: 'K03-63', icon:''}], date: "23 12 2009", photosUrl:'https://vtech.pl/katalog/logo/chip-tuning-BMW-M4-F82-3.0-431-KM-317-kW-AT.png', name:"Stock", description:'Seryjne autko bezz modyfikacji', company:"Kiwi racing factory", performance:[{type:"hp", value:510}, {type:"nm", value:640}]},
